...
architecture arch of stackmachine2 is
    ...
    -- Dmem in
    signal dmem_address : std_logic_vector(DATA_ADDR_WIDTH-1 downto 0);
...
begin
    ...
    process (all) begin
        ...
        -- OP_ILOAD
            ...
            imem_enable <= '0';
            pc_adder_in <= (others => '0');
            dmem_address <= std_logic_vector(resize(unsigned(imem_data_out_offset1),DATA_ADDR_WIDTH));
            dmem_data_in <= (others => '0');
            dmem_op <= MEM_READ;
            dmem_enable <= '1';
            main_adder_a <= (others => '0');
